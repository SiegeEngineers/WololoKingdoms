...
private:
	...
	void shallowRecCopy(boost::filesystem::path const &src, boost::filesystem::path const &dst, bool skip = false, bool force = false);
	...
	void copyWallFiles(boost::filesystem::path inputDir, boost::filesystem::path outputDir);
